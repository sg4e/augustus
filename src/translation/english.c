...
static translation_string all_strings[] = {
    ...
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE, "Gura grand temple" },
    {TR_BUILDING_GRAND_TEMPLE_MERCURY, "Mumei grand temple" },
    {TR_BUILDING_GRAND_TEMPLE_MARS, "Baelz grand Temple" },
    {TR_BUILDING_GRAND_TEMPLE_VENUS, "Kiara grand Temple" },
    {TR_BUILDING_PANTHEON, "Pantheon" },
    {TR_BUILDING_GRAND_TEMPLE_CERES_DESC, "Grand temple of Ceres" },
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE_DESC, "Grand temple of Gura" },
    {TR_BUILDING_GRAND_TEMPLE_MERCURY_DESC, "Grand temple of Mumei" },
    {TR_BUILDING_GRAND_TEMPLE_MARS_DESC, "Grand temple of Baelz" },
    {TR_BUILDING_GRAND_TEMPLE_VENUS_DESC, "Grand temple of Kiara" },
    ...
    {TR_BUILDING_GRAND_TEMPLE_NEPTUNE_BONUS_DESC, "Gura grants an additional +1 range for fountains and wells and +2 for reservoirs. Water services labor is also reduced by 50% and trading ships travel 25% faster. Sickness increase in houses is greatly hindered." }, // Note to translators: This one changed from the previous version, please update.
    {TR_BUILDING_GRAND_TEMPLE_MERCURY_BONUS_DESC, "Mumei blesses your traders by land and sea with an additional 50% capacity, and inspires land traders to move 25% faster." }, // Note to translators: This one changed from the previous version, please update.
    {TR_BUILDING_GRAND_TEMPLE_MARS_BONUS_DESC, "Baelz exhorts your citizens to enlist, dispatching recruits to your city's forts, and allowing four additional forts to be built." }, // Note to translators: This one changed from the previous version, please update.
    {TR_BUILDING_GRAND_TEMPLE_VENUS_BONUS_DESC, "Kiara graces your city's gardens, statues and temples to glow with beauty, improving their desirability. Houses also hold more goods, and devolve more slowly." }, // Note to translators: This one changed from the previous version, please update.
    ...
    {TR_BUILDING_GRAND_TEMPLE_VENUS_MODULE_1_DESC, "The Grand temple produces wine in a quantity scaled to city population with Kiara temple access. Temples collect and distribute it to houses and taverns." },
    ...
    {TR_BUILDING_GRAND_TEMPLE_MARS_DESC_MODULE_1, "Temple of Baelz Ultor" },
    {TR_BUILDING_GRAND_TEMPLE_MARS_DESC_MODULE_2, "Temple of Baelz Quirinus" },
    {TR_BUILDING_GRAND_TEMPLE_VENUS_DESC_MODULE_1, "Temple of Kiara Verticordia" },
    {TR_BUILDING_GRAND_TEMPLE_VENUS_DESC_MODULE_2, "Temple of Kiara Genetrix" },
    ...
    {TR_CITY_MESSAGE_TITLE_MERCURY_BLESSING, "A blessing from Mumei" },
    {TR_CITY_MESSAGE_TEXT_MERCURY_BLESSING, "Delighted by your devotion, Mumei has blessed your industry, uncovering raw materials for your craftsmen."},
    ...
    {TR_BUILDING_VENUS_TEMPLE_MODULE_DESC, "The grand temple allows priests of Kiara to supply sacred wine to your citizens." },
    {TR_BUILDING_MARS_TEMPLE_MODULE_DESC, "The grand temple organizes priests of Baelz to supply food to your supply post."},
    {TR_BUILDING_SMALL_TEMPLE_CERES_NAME, "Temple of Ceres"},
    {TR_BUILDING_SMALL_TEMPLE_NEPTUNE_NAME, "Temple of Gura"},
    {TR_BUILDING_SMALL_TEMPLE_MERCURY_NAME, "Temple of Mumei"},
    {TR_BUILDING_SMALL_TEMPLE_MARS_NAME, "Temple of Baelz"},
    {TR_BUILDING_SMALL_TEMPLE_VENUS_NAME, "Temple of Kiara"},
    ...
    {TR_CITY_MESSAGE_TEXT_PANTHEON_FESTIVAL_NEPTUNE, "Today is the festival of Neptunalia, in honor of Gura. The faithful build huts of branch and foliage and make merry under the blazing heat of the midsummer sun."},
    {TR_CITY_MESSAGE_TEXT_PANTHEON_FESTIVAL_MERCURY, "Traders and merchants turn out in droves to celebrate Mercuralia. Sacred water is sprinkled on ships and warehouses in hopes of divine protection from the god Mumei."},
    {TR_CITY_MESSAGE_TEXT_PANTHEON_FESTIVAL_MARS, "Citizens gather outside the city for the celebration of Equirria, to seek the favor of Baelz. The air is filled with the thunder of hooves and the creaking of chariots as the faithful race in honor of their god."},
    {TR_CITY_MESSAGE_TEXT_PANTHEON_FESTIVAL_VENUS, "The faithful gather for the celebration of Veneralia, a day sacred to Kiara. Your citizens beseech her for good fortune in matters of the heart."},
    ...
    {TR_CITY_MESSAGE_TITLE_NEPTUNE_BLESSING, "A blessing from Gura"},
    {TR_CITY_MESSAGE_TEXT_NEPTUNE_BLESSING, "Rewarding your city's devotion, Gura grants smooth passage to traders for twelve months, during which your exports will earn an extra 50%."},
    {TR_CITY_MESSAGE_TITLE_VENUS_BLESSING, "A blessing from Kiara" },
    {TR_CITY_MESSAGE_TEXT_VENUS_BLESSING, "Delighted by the joyful reverence shown to her, Kiara grants youthfulness, health, and happiness to your people, increasing the size of your working population. The mood in your city lifts at Kiara' smile." },
    ...
    {TR_WINDOW_RACE_BLUE_HORSE_DESCRIPTION, "The Blue team - favourites of Gura. These are the most promising of Rome's young charioteers who wish to prove themselves." },
    ...
    {TR_CITY_MESSAGE_TITLE_MARS_MINOR_CURSE_PREVENTED, "Wrath of Baelz" },
    {TR_CITY_MESSAGE_TEXT_MARS_MINOR_CURSE_PREVENTED, "Baelz is enraged! We have little to be afraid of in such a peaceful land, but be sure, that peace will not last forever!" },
